<?php 
    ...
    try {
        ...
        if (isset($_POST['btn_filter_day'])) {
            ...
            $result = $admin->generateSalesGraphOfDate('tbl_order', $start, $end);
        ...
        if (isset($_POST['btn_filter_month'])) {
            ...
            $result = $admin->generateSalesGraphOfMonth('tbl_order', $start[1], $end[1]);
        ...
        if (isset($_POST['btn_filter_year'])) {
            ...
            $result = $admin->generateSalesGraphOfYear('tbl_order', $start[0], $end[0]);
