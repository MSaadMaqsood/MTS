                            ...
                            <div class="card-body" style="height: 400px; overflow: scroll;">
                                <table class="table table-striped" id="example1">
                                    ...
                                    <tbody id="myTable">
                                        <tr>
                                            <td>Dashboard</td>
                                            <td>This button will land you on a page where you can see all the progress of your store.</td>
                                            <td><strong>ALT + a</strong></td>
                                        </tr>
                                        <!-- <tr>
                                            <td>Sales Report</td>
                                            <td>This button will land you on a page where you can generate the graph of your sales base on yearly, monthly or days wise.</td>
                                            <td><strong>ALT + g</strong></td>
                                        </tr>
                                        <tr>
                                            <td>Books Report</td>
                                            <td>This button will land you on a page where you can generate the graph of your product sales base on yearly, monthly or days wise.</td>
                                            <td><strong>ALT + i</strong></td>
                                        </tr> -->
                                        <tr>
                                            <td>Category</td>
                                            <td>This button will land you on a page where you can add categories that could be added to your product. And can also edit or delete the category.</td>
                                            <td><strong>ALT + c</strong></td>
                                        </tr>
                                        <tr>
                                            <td>Add Book</td>
                                            <td>This button will land you on a page where you can add new product to your store.</td>
                                            <td><strong>ALT + p</strong></td>
                                        </tr>
                                        <tr>
                                            <td>Books List</td>
                                            <td>This button will land you on a page where you can see all the information related to your store products. And you can also edit or delete a certain/specific product on that page.</td>
